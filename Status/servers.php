...
$FILENAME = 'servers/pub3/Bec_beConfig.xml';		// SET CORRECT STATUS FILE NAME HERE 
$ServerIP = "74.201.57.232";				// SET CORRECT SERVER IP.. HERE
$ServerPort = 2330;						// SET CORRECT SERVER PORT HERE
...
div.main {
	width: 560px;
	background: url(./themes/cod_ghost/images/flat2_hover.png);
	color:#ffffff;
	margin:50 auto;
}
...
#topframe {
	height: 35px; 
	width: 560px; 
	background: url(./themes/cod_ghost/images/menutitle.jpg);
	font-family: Impact;
	font-size : 18px;
...
<div class='main'>
	...
	<div id='topframe' title='Start steam and join the server'>
		<div style='display:inline-block;margin-top:2px;'>
			<img src = 'favicon.ico' style='height:24px;padding-left:2px;vertical-align:text-top;'/>
		</div>
		<div style='display:inline-block;margin-top:-2px;'>
	...
	<br />
	<div id='general2'>Current Players</div>
	<br />
	<hr style='margin-top:-2px;'/>";
